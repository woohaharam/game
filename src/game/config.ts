...
export const ENEMIES: Record<EnemyKind, EnemyStats> = {
  grunt: {
    kind: 'grunt', health: 26, radius: 12, speed: 118, contactDamage: 1,
    score: 10, color: '#ff5c7a', knockbackScale: 1, cost: 1,
  },
  shooter: {
    kind: 'shooter', health: 22, radius: 12, speed: 92, contactDamage: 1,
    score: 15, color: '#ffb03a', knockbackScale: 1, cost: 1.5,
  },
  bomber: {
    kind: 'bomber', health: 30, radius: 13, speed: 168, contactDamage: 0,
    score: 18, color: '#c98bff', knockbackScale: 0.8, cost: 1.5,
  },
  turret: {
    kind: 'turret', health: 46, radius: 15, speed: 0, contactDamage: 1,
    score: 20, color: '#4de2c0', knockbackScale: 0, cost: 2,
  },
  brute: {
    kind: 'brute', health: 96, radius: 20, speed: 96, contactDamage: 2,
    score: 45, color: '#ff3d5e', knockbackScale: 0.35, cost: 3.5,
  },
  boss: {
    kind: 'boss', health: 620, radius: 42, speed: 78, contactDamage: 2,
    score: 400, color: '#ff2d6f', knockbackScale: 0, cost: 0,
  },
};
