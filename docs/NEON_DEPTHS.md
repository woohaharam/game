...
_One of two games in this repository — see the [repository README](../README.md) for the other._
...
![Combat on floor three](media/combat.png)
...
<table>
<tr>
<td width="50%"><img src="media/upgrade.png" alt="Upgrade selection" /></td>
<td width="50%"><img src="media/boss.png" alt="The Warden boss fight" /></td>
</tr>
<tr>
...
[`docs/ARCHITECTURE.md`](ARCHITECTURE.md), and the latest simulated
balance report in [`docs/BALANCE.md`](BALANCE.md).
...
— are written down in [`docs/REPOSITORY_SETUP.md`](REPOSITORY_SETUP.md).
